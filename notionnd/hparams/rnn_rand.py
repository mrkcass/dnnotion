def init_hparams(hyper_dict):
    ...
    hyper_dict['ma'] = {
        ...
        'value': -1}
    hyper_dict['oa'] = {
        'description': "output layer activation function (relu, tanh, sigmoid, elu, selu, crelu, relu6, softsign, softplus, linear)",
        'default': 'linear',
        'value': 'linear'}
    hyper_dict['ob'] = {
    ...
    hyper_dict['df'] = {
        ...
        'value': 3}
    hyper_dict['wa'] = {
        'description': "word vector normalize layer activation function (relu, tanh, sigmoid, elu, selu, crelu, relu6, softsign, softplus, linear)",
        'default': 'linear',
        'value': 'linear'}
    hyper_dict['wc'] = {
    ...
    hyper_dict['wv'] = {
        ...
        'default': "",
        'value': "../../data/current4/wordvectors_400"}
    hyper_dict['wy'] = {
