def init_hparams(hyper_dict):
    ...
    hyper_dict['dx'] = {
        ...
        'value': 65}
    hyper_dict['fa'] = {
        'description': "fully connected layer activation function (relu, tanh, sigmoid, elu, selu, crelu, relu6, softsign, softplus, linear)",
        'default': 'relu',
        'value': 'tanh'}
    hyper_dict['fb'] = {
        'description': "fully connected layer bias initializer",
        'default': 0.0,
        'value': 0.0}
    hyper_dict['fd'] = {
        'description': "fully connected layer dropout rate",
        'default': .5,
        'value': 0.0}
    hyper_dict['ff'] = {
        'description': "fully connected layer weight initializer use scaling factor",
        'default': [1.0, 2.0],
        'value': 1.0}
    hyper_dict['fm'] = {
        'description': "fully connected layer weight initializer mode",
    ...
    hyper_dict['fw'] = {
        ...
        'value': 0}
    hyper_dict['fu'] = {
        'description': "fully connected layer weight initializer use uniform mode",
        'default': False,
        'value': False}
    hyper_dict['ld'] = {
    ...
    hyper_dict['ma'] = {
        ...
        'value': -1}
    hyper_dict['oa'] = {
        'description': "output connected layer activation function (relu, tanh, sigmoid, elu, selu, crelu, relu6, softsign, softplus, linear)",
        'default': 'linear',
        'value': 'sigmoid'}
    hyper_dict['ob'] = {
    ...
    hyper_dict['o2'] = {
        ...
        'value': 0.0005}
    hyper_dict['ra'] = {
        'description': "recurrent layer activation function (relu, tanh, sigmoid, elu, selu, crelu, relu6, softsign, softplus, linear)",
        'default': 'tanh',
        'value': 'tanh'}
    hyper_dict['rb'] = {
        ...
        'value': 0.7}
    hyper_dict['rc'] = {
        'description': "recurrent layer cell type: lstm (vanilla lstm). clstm (coupled input-forget gate lstm), gru (gated recurrent unit) ugrnn",
        'default': 'clstm',
        'value': 'ugrnn'}
    hyper_dict['rd'] = {
    ...
    hyper_dict['ro'] = {
        ...
        'value': 'output'}
    hyper_dict['rp'] = {
        'description': "recurrent layer lstm cells use peephoes",
        'default': False,
        'value': False}
    hyper_dict['rr'] = {
    ...
    hyper_dict['rw'] = {
        ...
        'value': 190}
    hyper_dict['tb'] = {
        'description': "batch size - number of training examples in a batch",
        'default': 1024,
        'value': 90}
    hyper_dict['tc'] = {
    ...
    hyper_dict['tf'] = {
        ...
        'value': 300}
    hyper_dict['tg'] = {
        'description': "ok indicator abort threshold. abort when greater than value",
        'default': .5,
        'value': .55}
    hyper_dict['th'] = {
