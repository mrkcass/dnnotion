def init_hparams(hyper_dict):
    ...
    hyper_dict['th'] = {
        ...
        'value': True}
    hyper_dict['cb'] = {
        'description': "convolution layer bias initializer",
        'default': 0.0,
        'value': 0.0}
    hyper_dict['cd'] = {
        ...
        'value': .2}
    hyper_dict['cf'] = {
        'description': "convolution layer weight initializer use scaling factor",
        'default': [1.0, 2.0],
        'value': 1.0}
    hyper_dict['cm'] = {
        'description': "convolution layer weight initializer mode",
    ...
    hyper_dict['cu'] = {
        'description': "convolution layer weight initializer use uniform mode",
        'default': False,
        'value': False}
    hyper_dict['cw'] = {
    ...
    hyper_dict['ob'] = {
        ...
        'value': 0.0}
    hyper_dict['of'] = {
        'description': "output layer weight initializer use scaling factor",
        'default': [1.0, 2.0],
        'value': 1.0}
    hyper_dict['om'] = {
    ...
    hyper_dict['tr'] = {
        ...
        'value': 60}
    hyper_dict['ts'] = {
        'description': "epochs to train using tf shuffler before again using dnnotion shuffler",
        'default': 10,
        'value': 60}
    hyper_dict['tt'] = {
